/* Phoenix-SHAKE-512s parameter definitions */
...
#define PH_TFORS_K 57
#define PH_TFORS_HEIGHT (PH_TFORS_LOG_K_PRIME + PH_TFORS_A)
#define PH_TFORS_T (1 << PH_TFORS_A)
/* Winternitz parameter. */
#define PH_GWOTSC_W1 32
#define PH_GWOTSC_LOGW1 5
#define PH_GWOTSC_W2 64
#define PH_GWOTSC_LOGW2 6

/* Address length in bytes. */
#define PH_ADDR_BYTES 32

/* GWOTSC chain lengths. */
#define PH_GWOTSC_W1_LEN 94
#define PH_GWOTSC_W2_LEN 7
