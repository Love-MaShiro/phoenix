/* Phoenix-SHAKE-256f parameter definitions */
...
#define PH_TFORS_K 47
#define PH_TFORS_HEIGHT (PH_TFORS_LOG_K_PRIME + PH_TFORS_A)
#define PH_TFORS_T (1 << PH_TFORS_A)
/* Winternitz parameter. */
#define PH_GWOTSC_W1 16
#define PH_GWOTSC_LOGW1 4
#define PH_GWOTSC_W2 32
#define PH_GWOTSC_LOGW2 5

/* Address length in bytes. */
#define PH_ADDR_BYTES 32

/* GWOTSC chain lengths. */
#define PH_GWOTSC_W1_LEN 39
#define PH_GWOTSC_W2_LEN 20
...
#define GWOTSC_EXPECTED_SUM ( \
    ((PH_GWOTSC_W1_LEN * (PH_GWOTSC_W1 - 1)) + \
     (PH_GWOTSC_W2_LEN * (PH_GWOTSC_W2 - 1))) / 2 \
    )
