...
/* These functions are used for WOTS and TFORS addresses. */
...
#define set_leaf_index SPX_NAMESPACE(set_leaf_index)
void set_leaf_index(uint32_t addr[8], uint32_t leaf_index);
