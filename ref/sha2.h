...
#ifdef SPX_SHA512
#pragma message "SPX_SHA512 IS DEFINED"
#else
#pragma message "SPX_SHA512 IS NOT DEFINED"
#endif
...
#if !defined(SPX_SHA512) && SPX_SHA256_OUTPUT_BYTES < SPX_N
...
void mgf1_256(uint8_t *out, size_t outlen, const uint8_t *in, size_t inlen);
void mgf1_512(uint8_t *out, size_t outlen, const uint8_t *in, size_t inlen);
